...
uses
  ...
  dxScrollbarAnnotations, Vcl.Mask;
...
type
  TfrmListEmployeeOrg = class(TFrame)
    ...
    cxGrid1DBTableView1typeList: TcxGridDBColumn;
    cxGrid1DBTableView1statusList: TcxGridDBColumn;
    cxGrid1DBTableView1dateCreate: TcxGridDBColumn;
    cxGrid1DBTableView1countEmplList: TcxGridDBColumn;
    cxGrid1DBTableView1countEndEmpl: TcxGridDBColumn;
...
uses DM, createListEmployee, MainForm;
