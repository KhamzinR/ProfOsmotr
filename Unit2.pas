...
uses
        ...
        Vcl.Controls, Vcl.Forms, Vcl.Dialogs, scExtControls, scAppPager,
        scControls,
        Vcl.StdCtrls, scImageCollection, Vcl.ImgList, Vcl.Themes,
        System.UITypes,
...
type
        TAppPagerForm = class(TForm)
                ...
                procedure scAppPager1KeyDown(Sender: TObject; var Key: Word;
                  Shift: TShiftState);
                procedure scAdvancedListBox1KeyDown(Sender: TObject;
...
begin
        ...
        scMessageDlg('Item can be without linked page!', mtInformation,
          [mbOk], 0);
end;
